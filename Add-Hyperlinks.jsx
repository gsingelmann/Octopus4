...
//Project: https://github.com/grefel/createHyperlinks
//Adapted to Octopus-Envelope in Feb-2025
//Contact: Gregor Fellenz - http://www.publishingx.de

#targetengine "octopus-ua-checktypo";
#include "../Octopus-include.jsxinc"
__init();
var script_name = "Add-Hyperlinks";
    ...
    */
    ...
    INNER.showMessages = function (title, msgArray, type) {
        if (!INNER.disableAlerts && msgArray.length > 0 && !app.hasOwnProperty("serverHostName")) {
            ...
            var dialogWin = new Window("dialog", title);
            dialogWin.script_name = script_name;
            __insert_head( dialogWin );
...
function getConfig(dok) {
    ...
    with (win) {
        ...
        win.pInfo = add("panel", undefined, __('what links'));
        ...
        with (win.pInfo) {
            ...
            with (win.pInfo.gInfo) {
                win.pInfo.gInfo.addWebLinks = add("checkbox", undefined, __('create web'));
                win.pInfo.gInfo.addWebLinks.value = true;
                win.pInfo.gInfo.addMailLinks = add("checkbox", undefined, __('create mailto'));
                win.pInfo.gInfo.addMailLinks.value = true;
                win.pInfo.gInfo.allowLongTLDs = add("checkbox", undefined, __('long tld'));
                win.pInfo.gInfo.allowLongTLDs.value = true;
            }
        }

        win.pCharStyle = add("panel", undefined, __('apply cs'));
        ...
        with (win.pCharStyle) {
            ...
            with (win.pCharStyle.gInfo) {
                win.pCharStyle.gInfo.addCStyleCB = add("checkbox", undefined, __('apply'));
        ...
        win.pMasterSpread = add("panel", undefined, __('masterpage'));
        ...
        with (win.pMasterSpread) {
            ...
            with (win.pMasterSpread.gInfo) {
                ...
                with (win.pMasterSpread.gInfo.gZeichenformat) {
                    win.pMasterSpread.gInfo.gZeichenformat.addCStyleCB = add("checkbox", undefined, __('include master'));
        ...
        with (win.groupStart) {
            ...
            win.groupStart.butCancel = add("button", undefined, __('cancel'));
        }
    }
...
function initLog() {
    ...
    if (typeof px != "undefined") {
        ...
        var projectName = px.projectName.replace(/:/g, "_");
    }
