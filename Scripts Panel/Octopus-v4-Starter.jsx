  ...
  function update_resources(configs) {
    try {
      ...
      for (var _nc = 0; _nc < configs.length; _nc++) {
        ...
        // if check == 0 -> Ziel soll nur einmal installiert werden.
        if (is_new || ( c.check && !eq_filesize(c.check, tgt_path) ) ) {
  ...
  switch (key) {
    ...
    case "where-is":
      return localize({
        ...
        "es": decodeURI("%C2%BFD%C3%B3nde%20est%C3%A1%20el%20paquete%20descomprimido?")
      });
    case "cancel":
      return localize({
        "de": "Abbrechen",
    ...
    case "local":
      return localize({
        ...
        "es": decodeURI("Instalaci%C3%B3n%20local")
    ...
    case "remote":
      return localize({
        ...
        "es": decodeURI("Instalaci%C3%B3n%20en%20l%C3%ADnea")
    ...
    case "offline":
      return localize({
        ...
        "es": decodeURI("Instalaci%C3%B3n%20fuera%20de%20l%C3%ADnea")
    ...
    case "server":
      return localize({
        ...
        "es": decodeURI("Instalaci%C3%B3n%20en%20el%20servidor")
      })
    case "online":
      return localize({
        "de": "Online Quelle benutzens",
        "en": "Use Online Source",
        "es": decodeURI("Utilice%20una%20fuente%20en%20l%C3%ADnea")
      })
    case "local_desc":
      return localize({
    ...
    case "already-there":
      return localize({
        ...
        "es": decodeURI("Al%20parecer%2C%20ya%20existe%20una%20versi%C3%B3n%20antigua%20de%20Octopus.%0A%0A%C2%BFDesea%20cancelar%20para%20eliminarla%3F%0A%0A%22S%C3%AD%22%20%E2%89%88%20Las%20carpetas%20de%20Octopus%20se%20abrir%C3%A1n%20en%20Finder%2FExplorador.%0A%22No%22%20%E2%89%88%20Esta%20instalaci%C3%B3n%20contin%C3%BAa%20con%20consecuencias%20no%20probadas.%20Desconocemos%20c%C3%B3mo%20se%20comportan%20dos%20versiones%20de%20Octopus%20ejecut%C3%A1ndose%20en%20paralelo.")
      })
    case "nu-script":
      return localize({
        "de": "Folgende Dateien wurden installiert",
        "en": "The following files have been installed",
        "es": "Se instalaron los siguientes archivos"
      })
    case "old-script":
      return localize({
        "de": "Folgende Dateien waren bereits installiert",
        "en": "The following files were already installed",
        "es": "Los siguientes archivos ya estaban instalados"
      })
    case "updated-script":
      return localize({
        "de": "Folgende Dateien wurden aktualisiert",
        "en": "The following files have been updated.",
        "es": "Se actualizaron los siguientes archivos"
      })
    case "failed-script":
      return localize({
        "de": "Folgende Dateien konnten nicht installiert werden",
        "en": "The following files could not be installed",
        "es": "Los siguientes archivos no se pudieron instalar"
      })
    case "only-online-explainer":
      return localize({
        ...
        "es": decodeURI("Durante%20la%20instalaci%C3%B3n%2C%20los%20guiones%20y%20los%20datos%20se%20cargan%20desde%20el%20servidor%20de%20Project%20Octopus%20y%20se%20actualizan%20cada%20vez%20que%20se%20inicia%20InDesign.%0AAlgunos%20datos%20anonimizados%2C%20como%20datos%20de%20uso%20y%20mensajes%20de%20error%2C%20se%20env%C3%ADan%20al%20servidor%20de%20Project%20Octopus%20para%20apoyar%20el%20desarrollo%20de%20Project%20Octopus.%0A%0ANo%20se%20recopila%20ni%20se%20almacena%20ning%C3%BAn%20dato%20personal.")
      })
    case "online-explainer":
      return localize({
        ...
        "es": decodeURI("Durante%20la%20instalaci%C3%B3n%20en%20l%C3%ADnea%2C%20los%20datos%20se%20cargan%20desde%20el%20servidor%20de%20Project%20Octopus%20y%20se%20actualizan%20cada%20vez%20que%20se%20inicia%20InDesign.%0AEste%20es%20el%20m%C3%A9todo%20de%20instalaci%C3%B3n%20preferido.")
      })
    case "online-explainer-1":
      return localize({
        ...
        "es": decodeURI("Con%20la%20instalaci%C3%B3n%20en%20l%C3%ADnea%2C%20los%20datos%20se%20descargan%20del%20servidor%20de%20Project%20Octopus%20y%20el%20script%20de%20inicio%20se%20configura%20para%20buscar%20actualizaciones%20en%20cada%20reinicio.%20%0A%0AEn%20la%20mayor%C3%ADa%20de%20los%20casos%2C%20este%20es%20el%20m%C3%A9todo%20de%20instalaci%C3%B3n%20preferido.")
      })
    case "fileserver-explainer":
      return localize({
        ...
        "es": decodeURI("Si%20coloca%20el%20paquete%20en%20una%20ubicaci%C3%B3n%20definida%20en%20su%20sistema%20de%20archivos%20(%E2%89%88%20servidor%20de%20archivos)%2C%20el%20instalador%20de%20Octopus%20podr%C3%A1%20obtener%20las%20actualizaciones%20desde%20all%C3%AD.%20%0A%0ASeleccione%20esta%20opci%C3%B3n%20si%20tiene%20varias%20instalaciones%20de%20InDesign%20y%20desea%20controlar%20usted%20mismo%20el%20ciclo%20de%20actualizaci%C3%B3n.")
      })
    case "offline-explainer":
      return localize({
        ...
        "es": decodeURI("Solo%20debe%20utilizar%20la%20instalaci%C3%B3n%20sin%20conexi%C3%B3n%20si%20la%20instalaci%C3%B3n%20en%20l%C3%ADnea%20causa%20problemas.%20%0ARequiere%20que%20haya%20descargado%20el%20paquete%20Octopus%20de%20GitHub.%20%0AColoque%20el%20paquete%20Octopus%20descargado%20en%20alg%C3%BAn%20lugar%20(%C2%BFquiz%C3%A1s%20en%20la%20carpeta%20%E2%80%9CDocumentos%E2%80%9D%3F)%20y%20d%C3%A9jelo%20all%C3%AD%20intacto.%20Por%20supuesto%2C%20las%20actualizaciones%20autom%C3%A1ticas%20de%20los%20scripts%20de%20Octopus%20no%20funcionar%C3%A1n%20despu%C3%A9s%20de%20una%20instalaci%C3%B3n%20sin%20conexi%C3%B3n.%20Deber%C3%A1%20descargar%20el%20paquete%20Octopus%20nuevamente%20para%20obtener%20nuevos%20scripts%20y%20ejecutar%20este%20script%20inicial%20nuevamente.%20%0APara%20recibir%20informaci%C3%B3n%20sobre%20las%20actualizaciones%2C%20suscr%C3%ADbase%20al%20bolet%C3%ADn%20en%20project-octopus.net")
      })
    case "offline-explainer-1":
      return localize({
        ...
        "es": decodeURI("La%20instalaci%C3%B3n%20sin%20conexi%C3%B3n%20requiere%20que%20hayas%20descargado%20el%20paquete%20Octopus%20desde%20project-octopus.net%20o%20GitHub.%20%0A%0ALos%20archivos%20se%20copian%20a%20la%20ubicaci%C3%B3n%20correcta%20y%20se%20dejan%20all%C3%AD.%20%0A%0APara%20las%20actualizaciones%20tendr%C3%ADa%20que%20repetir%20el%20proceso%3A%20descargar%20el%20paquete%20y%20ejecutar%20este%20guion.")
      })
    case "do_restart":
      return localize({
        ...
        "es": decodeURI("Para%20que%20la%20instalaci%C3%B3n%20surta%20efecto%2C%20es%20necesario%20reiniciar%20InDesign.%20%0A")
      });
    default:
      return key;
  }
